...
│                               this commit" (sourceOid ?? commit oid), palette "Blame…"
│                               (owner 2026-09-12: looked for it in ⌘K first) which reuses the
│                               File history file picker — palette `mode` is
│                               commands | fileHistory | blame, enterFilePicker(kind) loads
│                               repoFiles once and the group heading/icon/onSelect follow the
│                               mode. Demo: demoBlame
